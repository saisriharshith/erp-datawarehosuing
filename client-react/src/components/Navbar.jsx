...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="navbar navbar-expand-lg app-navbar px-3 py-2 sticky-top">
        <div className="container-fluid">
          ...
          <div className="d-flex align-items-center gap-3 ms-auto">
            ...
            <div className="d-none d-md-flex align-items-center gap-2 px-2 py-1 bg-light rounded border text-muted small">
            ...
            {user?.role === 'ADMIN' && (
              <button className="btn btn-sm btn-primary d-flex align-items-center gap-1" onClick={() => setShowETL(true)} style={{ background: '#4f46e5', borderColor: '#4f46e5' }}>
                ...
                <span>Run Live ETL</span>
              </button>
            )}

            {/* 20 Account Quick Switcher */}
            <div className="d-flex align-items-center gap-2">
              <select
